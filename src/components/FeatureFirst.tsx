...
export default function Features() {
  ...
  return (
    <section className="bg-muted py-12 md:py-20 lg:py-32" id="Features">
      <div className="bg-linear-to-b absolute inset-0 -z-10 sm:inset-6 sm:rounded-b-3xl dark:block dark:to-[color-mix(in_oklab,var(--color-zinc-900)_75%,var(--color-background))]"></div>
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16 lg:space-y-20 dark:[--color-border:color-mix(in_oklab,var(--color-white)_10%,transparent)]">
        <div className="relative z-10 mx-auto max-w-2xl space-y-6 text-center">
          <h2 className="text-balance text-4xl font-semibold lg:text-6xl">Layanan untuk Anda</h2>
          <p>E-DocumentISO mendukung kemudahan akses dokumen dan platform yang membantu mengembangkan bisnis untuk berinovasi.</p>
        </div>
