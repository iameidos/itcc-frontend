...
export default function CallToAction() {
  return (
    <>
      <section className="py-16 lg:py-20 text-center bg-accent">
        ...
        <ButtonLink variant="secondary" href="/kontak" className="inline-block font-semibold px-8 py-3 rounded-md shadow transition">
          Hubungi Kami
        </ButtonLink>
      </section>
    </>
